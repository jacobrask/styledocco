(function() {
  var file, files, findit, fs, generateFile, getResourcePath, getSections, jade, key, langs, link, marked, menu, mkdirp, optimist, options, parser, parts, path, readme, readmeText, sections, sources, templateFile, writeFile, writeStaticFile, _, _i, _len;
