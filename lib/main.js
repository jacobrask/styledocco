(function() {
  var Language, buildRootPath, cssPath, exec, files, findit, fs, generateIndex, generateSourceHtml, getLanguage, inputDir, jade, languages, links, makeDestination, makeSections, marked, mkdirp, optimist, options, outputDir, path, preProcess, renderTemplate, sources, templateDir, trimNewLines, writeFile;
