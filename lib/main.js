(function() {
  ...
  generateSourceHtml = function(source, sourceFiles, sections) {
    ...
    return preProcess(source, function(err, css) {
      ...
      return renderTemplate('docs', content, function(err, html) {
        if (err != null) throw err;
  ...
  generateReadme = function(sourceFiles, cb) {
    ...
    return getReadme(function(err, html, readmePath) {
      var content, title;
      if (html == null) {
      ...
      return renderTemplate('readme', content, function(err, html) {
