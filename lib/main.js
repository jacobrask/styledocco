(function() {
  var buildRootPath, cssPath, file, files, findit, fs, generateIndex, generateSourceHtml, getLanguage, input, jade, key, languages, link, makeDestination, marked, menu, mkdirp, optimist, options, outputDir, overwriteResources, parser, parts, path, preProcess, renderTemplate, sources, templateDir, writeFile, _i, _len, _ref;
  ...
  _ref = require('./languages'), getLanguage = _ref.getLanguage, languages = _ref.languages;
