(function() {
  var buildRootPath, cssPath, currentDir, description, file, files, findFile, findit, fs, generateSourceHtml, input, jade, key, langs, link, makeDestination, marked, menu, mkdirp, optimist, options, outputDir, overwriteResources, parser, parts, path, preProcess, readme, renderTemplate, sources, templateDir, title, tokens, writeFile, _, _i, _len;
  ...
  files.forEach(function(file) {
    var code, diff, i, newToken, origTokens, sections, token, _len2;
