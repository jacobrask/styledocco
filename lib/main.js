(function() {
  var Language, code, exec, file, files, findit, fs, generateDocumentation, generateIndex, generateSourceHtml, getLanguage, inputDir, jade, languages, makeDestination, makeSections, marked, mkdirp, optimist, options, outputDir, path, preProcess, relative_base, renderTemplate, sections, sources, trimNewLines, writeFile, _i, _len;
  ...
  generateIndex = function(sourceFiles) {
