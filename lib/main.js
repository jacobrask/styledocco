(function() {
  var Language, buildRootPath, cssPath, exec, file, files, findit, fs, generateIndex, generateSourceHtml, getLanguage, inputDir, jade, key, languages, link, makeDestination, makeSections, marked, menu, mkdirp, optimist, options, outputDir, parts, path, preProcess, renderTemplate, sources, templateDir, trimNewLines, writeFile, _i, _len;
