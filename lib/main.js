(function() {
  var check_config, content_template, destination, docco_styles, docco_template, ensure_directory, exec, ext, file_exists, fs, generateDocumentation, generate_content, generate_readme, generate_source_html, get_language, highlight_end, highlight_start, jade, l, languages, marked, parse, parse_args, parse_markdown, path, relative_base, spawn, walk, write_file, _, _ref;
  ...
  check_config = function(context) {
    ...
    return context.config = _.extend(defaults);
  };
