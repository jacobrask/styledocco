(function() {
  var Language, destination, docco_template, ensureDirectory, exec, file_exists, fs, generateDocumentation, generateReadme, generateSourceHtml, getLanguage, jade, languages, makeSections, marked, parseArgs, path, preProcess, relative_base, trimNewLines, walk, writeFile;
