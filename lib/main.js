(function() {
  var Language, exec, files, findit, fs, generateIndex, generateSourceHtml, getLanguage, inputDir, jade, languages, links, makeDestination, makeSections, marked, mkdirp, optimist, options, outputDir, path, preProcess, renderTemplate, sources, trimNewLines, writeFile;
