(function() {
  ...
  Language = (function() {
    ...
    Language.prototype.compile = function(filename, passthrough_args, cb) {
      var args;
      if (this.preprocessor != null) {
        if ((passthrough_args != null) && typeof passthrough_args === "string") {
          passthrough_args = [passthrough_args];
        }
        args = [].concat(this.preprocessor.args);
        if (passthrough_args) args = args.concat(passthrough_args);
