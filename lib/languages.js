...
// Compile to CSS (unless we're running in the browser.)
// TODO: Add support for compiling Less (and Stylus?) in the browser.
Language.prototype.compile = function(filename, customPreprocessor, cb) {
  if (typeof window !== 'undefined') {
    return console.warn('Preprocessing is not supported in the browser.');
  }
  var preCmd;
  if ((this.preprocessor != null) || customPreprocessor) {
    ...
    return child_process.exec(preCmd, function(err, stdout, stderr) {
      if (err != null) {
