(function() {
  ...
  exports.getDocTokens = function(filename) {
    var code, docs, lang;
    code = fs.readFileSync(filename, "utf-8");
    lang = langs.getLanguage(filename);
    docs = lang != null ? getDocs(lang, code) : code;
    return marked.lexer(docs);
  };
