(function() {
  ...
  generate_readme = function(context, sources, package_json) {
    var content, dest, readme_path, readme_template, source, title;
    title = "README";
  ...
  parse_markdown = function(context, src) {
    var markdown;
    markdown = file_exists(src) ? fs.readFileSync(src).toString() : void 0;
