(function() {
  var destination, docco_styles, docco_template, ensure_directory, exec, ext, file_exists, fs, generate_documentation, generate_html, generate_readme, get_language, highlight, highlight_end, highlight_start, l, languages, package_json, package_path, parse, parse_args, path, readme_markdown, readme_path, readme_template, relative_base, showdown, spawn, template, _ref;
  ...
  generate_readme = function(context) {
    var content, dest, html, source, target_dir, title, write_func;
    title = "README";
