(function() {
  var cloc, destination, docco_styles, docco_template, ensure_directory, exec, ext, file_exists, fs, generate_documentation, generate_html, generate_readme, get_language, highlight, highlight_end, highlight_start, l, languages, parse, parse_args, path, relative_base, showdown, spawn, template, _ref;
  ...
  parse = function(source, code) {
    var code_text, docs_text, has_code, in_multi, language, line, lines, multi_accum, parsed, save, sections, tag, _i, _j, _len, _len2, _ref;
    lines = code.split('\n');
    sections = [];
